...
/// <summary>The eight resize handles around a selected element, plus the two endpoint handles of a Line.</summary>
public enum Handle { TopLeft, Top, TopRight, Right, BottomRight, Bottom, BottomLeft, Left, Point1, Point2 }
