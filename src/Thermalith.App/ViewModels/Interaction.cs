...
/// <summary>A selection outline rectangle in display coordinates (bindable for multi-select adorners).</summary>
public sealed record SelRect(double Left, double Top, double Width, double Height);
