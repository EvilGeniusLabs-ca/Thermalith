...
#   ./Pack-MacApp.sh artifacts/thermalith/osx-arm64   # -> .../osx-arm64/Thermalith.app
#
# The bundle is always named Thermalith.app (no arch suffix) and is written
# INSIDE the per-RID publish dir, so a full build of both osx RIDs keeps them
# separate — artifacts/thermalith/osx-arm64/Thermalith.app and
# .../osx-x64/Thermalith.app — without baking the arch into the app name.
#
